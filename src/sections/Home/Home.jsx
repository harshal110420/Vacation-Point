export default function Home() {
  return (
    <div className="bg-white">
      {/* ... Your existing code for divs and styles ... */}
            ...
            <div className="mb-16 lg:my-auto lg:max-w-lg">
              <div className="mb-6 max-w-xl">
                ...
                <h2 className="mb-6 max-w-lg text-3xl font-extrabold text-slate-700 sm:text-5xl sm:leading-snug">
                  ...
                  YOUR NEXT
                  <span className="rounded-md bg-gradient-to-r inline-block bg-sky-400 from-lime-400 to-sky-400 px-2 font-bold text-white">
                    VACATIONS
                  </span>
                </h2>
                <p className="text-base text-gray-700 md:text-lg">
                  DIVE INTO OUR BEST RECOMMENDATIONS AND UNCOVER THE PERFECT
          ...
          <div className="flex h-full w-full space-x-3 overflow-hidden md:justify-end">
            <div className="hidden w-56 items-center space-y-3 lg:flex">
              <div className="overflow-hidden rounded-xl bg-yellow-400">
                <img
                  className="mx-auto h-full w-full object-cover md:h-80 md:w-full lg:h-60 lg:w-full xl:h-80 xl:w-full"
